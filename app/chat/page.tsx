...
export default function ChatPage() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "market":
        return <MarketDashboard className="p-6" />;
      case "trading":
        return <TradingTools className="p-6" />;
      case "watchlist":
        return <Watchlist className="p-6" />;
      case "status":
        return <ApiStatusDashboard className="p-6" />;
      default:
      ...
      {loading ? (
        ...
        <div className="flex-grow flex flex-col items-center justify-center text-center px-2">
          ...
          <p className="max-w-md text-gray-400 text-base sm:text-lg">
            I analyze market data to spot trading opportunities. Give me a coin
            ticker (e.g., $SOL), a contract address, a DexScreener link, or
  ...
  return (
    <div className="bg-[#01010e] min-h-screen w-full flex flex-col font-sans text-gray-300">
      ...
      <div className="w-full border-b border-gray-800 bg-gray-900/60 backdrop-blur-sm sticky top-0 z-50">
      ...
      <div className="flex-grow flex flex-col">
        {activeTab === "chat" ? (
          <>
            {renderChatContent()}
            {/* Chat Footer - only show for chat tab */}
            <footer className="w-full flex flex-col items-center pt-4 pb-6 sticky bottom-0 bg-[#01010e] px-2 sm:px-0">
              ...
              <p className="text-xs text-gray-600 mt-3 text-center px-2">
                Predictive Pulse AI may produce incorrect analysis. Always do
                your own research.
              </p>
            </footer>
          </>
        ) : (
          <div className="flex-grow bg-[#01010e] min-h-screen">
            {renderTabContent()}
          </div>
        )}
      </div>
