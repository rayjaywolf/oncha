...
export default function Header() {
  return (
    <header className="w-full fixed top-0 left-0 right-0 z-50 flex items-center justify-between py-4 px-8 md:px-50 bg-[#151517]/20 backdrop-blur-md text-white border-b border-[#252525]">
      ...
      <div>
        <button className="px-6 py-1 rounded-full bg-[#CBFB44] text-black font-medium text-md transition-colors hover:bg-lime-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#CBFB44]">
          Sign In
        </button>
      </div>
    </header>
